...
// Generated 2013-3-20 13:08:37 by Hibernate Tools 3.2.2.GA
...
public class SchemaVersion  implements java.io.Serializable {
    ...
    public SchemaVersion(String version, int versionRank, int installedRank, String description, String type, String script, Integer checksum, String installedBy, Date installedOn, int executionTime, boolean success) {
       this.version = version;
       this.versionRank = versionRank;
       this.installedRank = installedRank;
       this.description = description;
