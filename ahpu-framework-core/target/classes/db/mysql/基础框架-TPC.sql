...
INSERT  INTO `tpc_dict_type`(`ID`,`MODULE`,`CODE`,`MEMO`,`NAME`,`DEL_FLAG`,`CREATE_TIME`,`CREATE_USER`,`UPDATE_TIME`,`UPDATE_USER`) VALUES (10001,'system','CORE.GENDER','性别：男、女、未知','性别',NULL,NULL,'admin',NULL,NULL),(10002,'system','CORE.NODE.TYPE','节点类型：叶子节点和非叶子节点','节点类型',NULL,NULL,NULL,NULL,NULL),(10003,'system','CORE.ENABLED','状态有效性：有效，无效','状态有效性',NULL,NULL,NULL,NULL,NULL),(10004,'system','CORE.RESOURCE.TYPE','资源类型：URI、方法、菜单','资源类型',NULL,NULL,NULL,NULL,NULL),(10006,'system','CORE.FLOW.TYPE','流程类型','流程类型',NULL,NULL,NULL,NULL,NULL),(10005,'system','CORE.MODULE','模块类型：系统管理','模块类型',NULL,NULL,'admin',NULL,NULL),(10007,'system','CORE.ORG.AREA','机构的所属区域','机构区域',NULL,NULL,NULL,NULL,NULL);
...
insert  into `tpc_primarykey`(`CODE`,`NAME`) values (10,'TPC_ATTACHMENT'),(10,'tpc_login_log'),(10,'TPC_ROLE'),(30,'TPC_CONFIG'),(30,'TPC_DICT_TYPE'),(40,'TPC_ORGANIZATION'),(60,'BusinessStarFlow'),(80,'TEST_FLOW_LEAVE'),(90,'TPC_OPERATION'),(100,'TPC_USER'),(170,'TPC_DICT_ENTRY'),(190,'TPC_MENU'),(240,'TPC_RESOURCE');
...
insert  into `tpc_role_resource`(`ROLE_ID`,`RESOURCE_ID`) values (1,4),(1,5),(1,6),(1,7),(1,8),(1,10),(1,11),(1,12),(1,15),(1,16),(1,17),(1,18),(1,19),(1,20),(1,21),(1,22),(1,23),(1,24),(1,25),(1,221),(1,231),(1,232),(2,221),(2,231),(2,232);
